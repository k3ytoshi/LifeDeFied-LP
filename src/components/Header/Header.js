  ...
  render() {
    ...
    const navigation = (
      <div className="nav">
        ...
        <div className="nav-item" onClick={() => onClickMenu(3)}>Assets</div>
        <div className="nav-item" onClick={() => onClickMenu(4)}>Staking</div>
        <div className="nav-item" onClick={() => onClickMenu(5)}>Market</div>
        <div className="nav-item" onClick={() => onClickMenu(6)}>Networks</div>
        <div className="nav-item" onClick={() => onClickMenu(7)}>Identity</div>
        <div className="nav-item" onClick={() => onClickMenu(8)}>Product</div>
        <div className="nav-item" onClick={() => onClickMenu(9)}>Contact</div>
      </div>
    )
